# 🧠 Manual do Cérebro: RevOps & Partnerships
...
## ✍️ Regras de Ouro para Atualização (Commit Rules)

Para manter o cérebro vivo e íntegro, siga estas diretrizes:
...
3. **Versionamento:** Toda mudança significativa deve ser enviada ao GitHub via Cursor com mensagens de commit claras (ex: `feat: add contexto tech-partners`).
...
- **Google Drive:** Espelhamento para leitura em tempo real pelas IAs (Gemini).
- **GitHub:** Controle de versão e histórico institucional.
- **Cursor AI:** IDE principal para escrita e estruturação do cérebro.
